...
class Admin extends CI_Controller 
{
    ...
    {  
        ...
        // if ($where >0) {
        //     echo 'nomor invoice tidak diketahui';
        // }else {
        //     echo 'mantul diketahui';
        //     print_r($hasil['no_transaksi']);
    ...
    public function cariInvoice()
    {
        ...
        // pengkondisian w ganti 
     
        $this->load->view('admin/templates/header', $hasil);
        $this->load->view('admin/templates/navbar', $hasil);
        $this->load->view('admin/templates/sidebar',$hasil);

        if ($where == $hasil['no_transaksi']) {
            $this->load->view('admin/invoice', $hasil);
        }else {
           
            $this->load->view('admin/notfound_invoice', $hasil);
                }
    ...
    public function deleteInvoice($no_transaksi)
    {
        $where = array('no_transaksi' => $no_transaksi);

		$this->m_food->deleteData($where, 'transaksi');
