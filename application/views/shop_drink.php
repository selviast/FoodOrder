<div class="hero-wrap hero-bread" style="background-image: url('<?= base_url('assets/');?>images/header.jpg');">
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					<li><a href="<?= base_url('order');?>" >Makanan</a></li>
    		...
    		<div class="row">
				<?php $i=1; ?>
                <?php foreach ($minuman as $mk) :?>
                  
                <?php $i++; ?>
				
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="" width="250" height="250px" src="<?= base_url('assets/')?>upload/gambar/<?= $mk['gambar'];?>" alt="Colorlib Template">
