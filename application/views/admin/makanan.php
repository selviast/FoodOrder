              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>                                      
                    ...
                    <td>                                            
                      <a data-toggle="modal" data-target="#editData<?php echo $x;?>" class="badge badge-pill badge-warning" href="<?= base_url('admin/editData/'.$i['id_pesanan']);?>"> <i class="fas fa-edit"></i></i> edit</a>
                      <a onclick="javascript: return confirm('Anda yakin untuk menghapus?')" class="badge badge-pill badge-danger" href="<?= base_url('admin/deleteData/'.$i['id_pesanan']);?>"><i class="fas fa-trash-alt"></i> delete</a>
                    </td>
                    </td>
                  </tr> 
                  <?php $x++; ?>
...
<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">  
    <div class="modal-content">
      ...
      <?= form_open_multipart('admin/addDataMakanan')?>
